...
public class MonitoramentoTemperatura implements MonitoramentoTemperaturaPresenter {
    public static void main(String[] args) {
        ...
        MonitoramentoTemperaturaUseCaseImpl useCase = new MonitoramentoTemperaturaUseCaseImpl();
        // TODO: Criação e execução do apresentador
        MonitoramentoTemperatura apresentador = new MonitoramentoTemperatura();
        // TODO: Criação do controlador
        MonitoramentoTemperaturaController controller = new MonitoramentoTemperaturaController(useCase, apresentador);
